...
| 4 | Web API 端点未验证 | 不确定是否已实现 | 补充代码检查 |

### 🟢 低优先级

| # | 问题 | 影响 | 修复建议 |
|---|------|------|----------|
| 5 | SEO Processor 规格缺失 | 开发无指导 | 补充 `05-seo-processor.md` |
| 6 | 导出格式详细规格缺失 | 输出格式不明确 | 补充 `04-export-formats.md` |
...
- [ ] 检查 `web/app.py` 或类似文件中的 API 路由
- [ ] 检查 `sources/` 目录下的各个 Collector
